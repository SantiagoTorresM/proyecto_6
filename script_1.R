...
#Procesamiento
setwd('D:/OneDrive - Ministerio de Educación/Docencia 2024/ucontinental/mds/1_modelosestadisticos/dictado del curso/s2/')
...
summary(psp)
table(psp$SECTOR)
sector <- data.frame(table(psp$SECTOR))
